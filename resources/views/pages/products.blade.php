...
<div class="flex justify-between items-center mb-3">
    ...
    <button id="add-product-btn" onclick="clearForm(); document.getElementById('add-product-modal').classList.remove('hidden')" class="ml-4 p-2 bg-blue-500 text-white rounded">Add Product</button></div>
<hr>
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form id="addProductForm" hx-post="/api/products" hx-trigger="submit" hx-target="#products_list" hx-swap="innerHTML">
            ...
            <div class="flex justify-end">
                <button type="submit" id="add-btn" class="mr-4 p-2 bg-blue-500 text-white rounded">Add Product</button>
